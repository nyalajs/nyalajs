...
export abstract class BaseRepository<T> {
     ...
     *
     * Fails closed the same way requireTenantFilter() does: a tenant-aware
     * repository with no active tenant must not silently insert a row with
     * tenantId=undefined. Calling requireTenantFilter() (rather than
     * getTenantId() directly) is what enforces that.
     */
