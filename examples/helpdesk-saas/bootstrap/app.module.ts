...
import { TicketsController } from "../app/controllers/tickets.controller";
...
@Module({
    ...
    providers: [
        ...
        },
        {
            provide: Logger,
            useFactory: () => {
                return new Logger("helpdesk-saas");
            },
        },
        HealthCheckService,
        MetricsCollector,
        ...
        UsersService,
        TicketsService,
        // Repositories (tenant-aware — see app/repositories/base.repository.ts)
        TicketRepository,
